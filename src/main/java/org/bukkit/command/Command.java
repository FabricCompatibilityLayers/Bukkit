...
public abstract class Command {
	 ...
	 *
	 * @return true if the unregistration was successfull (the current registered CommandMap was the passed CommandMap
	 ...
	 *
	 * @param permissionMessage New permission message, null to indicate default message, or an empty string to indicate
	 *                          no message
	 *
	 * @return This command object, for linking
	 */
