...
public interface Inventory extends Iterable<ItemStack> {
	...
	/**
	 * Check if the inventory contains any ItemStacks with the given materialId and at least the minimum amount
	 * specified
	 *
	 * @param materialId The materialId to check for
	...
	/**
	 * Check if the inventory contains any ItemStacks matching the given ItemStack and at least the minimum amount
	 * specified
	 * This will only match if both the type and the amount of the stack match
	 *
	 * @param item   The ItemStack to match against
